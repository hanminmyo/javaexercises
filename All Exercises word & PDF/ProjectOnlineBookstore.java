...
class Bookstore 
{
    ...
    public Bookstore() 
    {
        ...
        books.add(new Book("The count of Monte Christo", "Alexander Dumas", "Adventure", 27.99));

        books.add(new Book("War and Peace", "Leo Tolstoy", "Historical Fiction", 39.99));
        books.add(new Book("Gone with the Wind", "Margaret Mitchell", "Historical Fiction, War Story", 49.99));
    ...
    public void displayBooksByGenre(String genre) 
{
    ...
    while (true) 
    {
        ...
        if (!found) 
        {
            System.out.println("Books in " + genre + " genre not found in the bookstore."); 
        }
...
public void addToCart(Book book) 
{
    if (books.contains(book)) {
        ...
        if (continueChoice.equalsIgnoreCase("View")) {
            viewCart();
        } else if (continueChoice.equalsIgnoreCase("Continue")) {
            // Continue shopping
...
////////////////////////MAIN CLASSS PROJECT ONLINE BOOKSTORE/////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////

public class ProjectOnlineBookstore 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println(" WELCOME TO ALEX ONLINE BOOKSTORE ");
